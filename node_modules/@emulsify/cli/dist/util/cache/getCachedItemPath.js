...
function getCachedItemPath(bucket, itemPath) {
    ...
    return (0, path_1.join)(constants_1.CACHE_DIR, bucket, (0, crypto_1.createHash)('md5').update(projectPath).digest('hex'), ...itemPath);
}
